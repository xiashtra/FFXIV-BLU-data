...
export const BLU_ACTIONS = {
	...
	ICE_SPIKES: {
		...
		notes: "Applies counter-attack buff.",
	},
	BLOOD_DRAIN: {
		id: 11395,
		name: 'Blood Drain',
	...
	TRANSFUSION: {
		...
		statusesApplied: ['BRUSH_WITH_DEATH'],
		notes: "Restores all HP and MP to one party member while killing self.",
	},
	FLYING_SARDINE: {
		id: 11423,
		name: 'Flying Sardine',
	...
	BAD_BREATH: {
		...
		damageType: damageType.magic,
		damageAspect: damageAspect.unaspected,
		notes: "Applies DoT and damage down debuff.",
	},
	DIAMONDBACK: {
		id: 11424,
		name: 'Diamondback',
	...
	MIGHTY_GUARD: {
		...
		notes: "Applies mitigation buff and damage down debuff.",
	},
	TOAD_OIL: {
		id: 11410,
		name: 'Toad Oil',
	...
	DOOM: {
		...
		notes: "Applies instant kill debuff.",
	},
	PECULIAR_LIGHT: {
		id: 11421,
		name: 'Peculiar Light',
	...
	MAGIC_HAMMER: {
		...
		notes: "Applies damage down debuff.",
	},
	AVAIL: {
		id: 18306,
		name: 'Avail',
		...
		notes: "Applies damage redirect buff.",
	},
	SONIC_BOOM: {
		id: 18308,
		name: 'Sonic Boom',
	...
	AETHERIAL_MIMICRY: {
		...
		notes: "Applies mitigation, damage, and healing buffs.",
	},
	SURPANAKHA: {
		id: 18323,
		name: 'Surpanakha',
		...
		attackPotency: 200,
		aoeAttackPotency: 100,
		notes: "Boosts own damage based on stacking buff.",
	},
	QUASAR: {
		id: 18324,
		name: 'Quasar',
	...
	BASIC_INSTINCT: {
		...
		notes: "Applies damage and healing buff.",
	},
	ULTRAVIBRATION: {
		id: 23277,
		name: 'Ultravibration',
...
export const BLU_STATUSES = {
	...
	BLEEDING: {
		...
		dotPotency: {
			'Aetherial Spark': 50,
			'Aetherial Spark + Bristle': 75,
			'Song of Torment': 50,
			'Song of Torment + Bristle': 75,
			'Nightbloom': 75,
		},
		duration: {
			'Aetherial Spark': 15,
		...
		notes: "Applied by 11386 Song of Torment, 23281 Aetherial Spark, and 23290 Nightbloom, with different durations and potencies (unless buffed). Will overwrite each other."
	},
	BRISTLE: {
		id: 1716,
		name: 'Boost',
